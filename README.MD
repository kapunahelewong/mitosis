...
![Example of devloping with Mitosis](https://cdn.builder.io/api/v1/file/assets%2FYJIGb4i01jvw0SRdL5Bt%2F868af1e6d9fd4923b18ecd1d892f3a6e)
...
Once completed, make sure to read the `README.md` file generated in your new project. It will explain the structure of your project and provide a walkthrough on how to build and test your components.

Read the full [getting started docs](https://mitosis.builder.io/docs/quickstart/) for more.

### Integration with Figma

To make generating Mitosis components easier and to keep your design system in code in sync with your design system in Figma, Mitosis [integrates with Figma](https://mitosis.builder.io/docs/figma).
...
- [More open-source projects from Builder] (https://github.com/orgs/BuilderIO/repositories?type=all&q=visibility%3Apublic+archived%3Afalse)

## Contribute

Are you interested in contributing? Visit the [CONTRIBUTING](CONTRIBUTING.md) docs to learn how to get set up and started!

Once you're ready, check out our [issues](https://github.com/BuilderIO/mitosis/contribute) page and grab your first issue!
